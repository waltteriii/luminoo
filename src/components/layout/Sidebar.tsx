          ...
          <div className="space-y-1">
            {viewModes.map((mode) => (
              <Button
                ...
                className={cn(
                  "w-full justify-start gap-2 text-foreground-muted hover:text-foreground min-h-[44px]",
      ...
      <div className="space-y-2">
        ...
        <div className="space-y-1">
          <Button
            ...
            className="w-full justify-start gap-2 text-foreground-muted hover:text-foreground min-h-[44px]"
          >
